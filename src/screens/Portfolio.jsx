        ...
        <Link className='home-div' to='/lancedev'>
          <div>
            <img className='home-logo'
              src='./lancedev/images/home-logo.png' />
          </div>
          <div>
      ...
      <div className='piece'>
        <div className='piece-title-div'>
          <a target="_blank"
            ...
            <img className='thumb'
              src='./lancedev/images/everfree-thumbnail.png' />
          </a>
      ...
      <div className='piece'>
        <div className='piece-title-div'>
          <a target="_blank"
            ...
            <img className='thumb'
              src='./lancedev/images/heed-thumbnail.png' />
          </a>
